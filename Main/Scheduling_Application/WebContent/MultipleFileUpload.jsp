...
<body class="homepage">
	...
	<div class="container">
		<div class="center wow fadeInDown">
	       ...
	       <tr>
			<td width="20%"><label for="txt_Uname">Select File Path:</label></td>
		    <td width="20%" ><input type="file"  multiple style="border-color: gray;"  name="txt_search" id="txt_search" /></td>
		 
			
											
											 <td width="30%"  align="left" ><input type="submit"  name="btn_Submit" id="btn_Submit" Value="Submit"><br>
			</td>
			</tr>
			</table>
